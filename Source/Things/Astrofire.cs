...
{
    public class Astrofire : AttachableThing, ISizeReporter
    {
        ...
        private const float MinTicksBetweenSparks = 150f;
        ...
        private float SpreadInterval
        {
            get
            {
                ...
                if (num < MinTicksBetweenSparks)
                {
                    num = MinTicksBetweenSparks;
                }
                return num;
            }
        }
        ...
        private void DoComplexCalcs()
        {
            ...
            if (base.Spawned)
            {
                ...
                {
                    TakeDamage(new DamageInfo(VGEDefOf.VGE_ExtinguishAstrofire, 10f));
                }
        ...
        protected void TrySpread()
        {
            ...
            if (!flag)
            {
                ...
                {
                    ((AstrofireSpark)GenSpawn.Spawn(VGEDefOf.VGE_AstrofireSpark, base.Position, base.Map)).Launch(this, intVec, intVec, ProjectileHitFlags.All);
                }
            }
            else
            {
