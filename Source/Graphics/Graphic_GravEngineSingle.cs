...
public class Graphic_GravEngineSingle : Graphic_Single, IGravEngineGraphic
{
    public Graphic_Single cooldownGraphic;
    ...
    public override void Init(GraphicRequest req)
    {
        ...
        cooldownGraphic = new Graphic_Single();
        cooldownGraphic.Init(req);
    }

    public override Graphic GetColoredVersion(Shader newShader, Color newColor, Color newColorTwo)
        => GraphicDatabase.Get<Graphic_GravEngineSingle>(path, newShader, drawSize, newColor, newColorTwo, data);

    public override string ToString()
        => $"{nameof(Graphic_GravEngineSingle)}(base=({base.ToString()}), cooldown=({cooldownGraphic}))";
}